...
csv_file_size = os.path.getsize('raw.csv')
print("File Size is :", csv_file_size/1024**2, " MB\n")
Table.append(["Writing CSV File", csv_end, csv_file_size/1024**2, 100-((csv_file_size/df.memory_usage(deep=True).sum())*100)])
...
print("File Size is :", csv_file_size/1024**2, " MB\n")
Table.append(["Writing zip Compressed CSV File", csv_end, csv_file_size/1024**2, 100-((csv_file_size/df.memory_usage(deep=True).sum())*100)])
...
print("File Size is :", csv_file_size/1024**2, " MB\n")
Table.append(["Writing gzip Compressed CSV File", csv_end, csv_file_size/1024**2, 100-((csv_file_size/df.memory_usage(deep=True).sum())*100)])
...
print("File Size is :", csv_file_size/1024**2, " MB\n")
Table.append(["Writing bz2 Compressed CSV File", csv_end, csv_file_size/1024**2, 100-((csv_file_size/df.memory_usage(deep=True).sum())*100)])
...
print("File Size is :", csv_file_size/1024**2, " MB\n")
Table.append(["Writing tar Compressed CSV File", csv_end, csv_file_size/1024**2, 100-((csv_file_size/df.memory_usage(deep=True).sum())*100)])
